...
export async function GET(
  ...
  pdf.text(
    formatCurrency(data.invoiceItemRate, data.currency as any),
    130,
    110
  );
  pdf.text(formatCurrency(data.total, data.currency as any), 160, 110);

  // Total Section
  pdf.line(20, 115, 190, 115);
  pdf.setFont("helvetica", "bold");
  pdf.text(`Total (${data.currency})`, 130, 130);
  pdf.text(formatCurrency(data.total, data.currency as any), 160, 130);
